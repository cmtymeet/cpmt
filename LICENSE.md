...
cpmt 0.1.0 is licensed under **LGPL-3.0-only WITH LGPL-3.0-linking-exception**.
...
Previously distributed releases retain their original grants. Existing release
tags, published archives and already prepared artifacts are not relicensed
or replaced.
